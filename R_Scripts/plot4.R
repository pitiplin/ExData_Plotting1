plot4 <- function(inputFile="../DATA_INPUT/household_power_consumption.txt", outputFolder="../DATA_OUTPUT"){
	...
	outputFile<-paste0(outputFolder, "/", "plot4.png")
	...
	legend("topright", legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_2"), lty=1, col=c("black","red","blue"), bty="n")
